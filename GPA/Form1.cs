...
namespace GPA
{
    public partial class GPA : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
          ...
          //  string chra= Convert.ToString(Q_p / crdhrs);
//            for (int i=0;i<3;i++)
//            {
...
//}
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("______________________________________________________________________________________________________", new Font("Arial", 20, FontStyle.Bold), Brushes.Black, new PointF(0, Y_axis+10));
            e.Graphics.DrawString("GPA", new Font("Arial", 20, FontStyle.Bold), Brushes.Black, new PointF(500, Y_axis + 50));
            e.Graphics.DrawString(label8.Text, new Font("Arial", 20, FontStyle.Bold), Brushes.Black, new PointF(600, Y_axis + 50));
        }
